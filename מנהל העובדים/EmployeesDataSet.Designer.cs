...
namespace ManagerEmployees {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public employeesRow AddemployeesRow(string firstName) {
...
namespace ManagerEmployees.EmployeesDataSetTableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [employees] ([firstName]) VALUES (@firstName)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [employees] SET [firstName] = @firstName WHERE (([ID] = @Original_ID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ManagerEmployees.Properties.Settings.Default.EmployeesConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [ID], [firstName] FROM [employees]";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@firstName", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, true, 0, 0, "firstName", global::System.Data.DataRowVersion.Current, null));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Nqwwsw", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, true, 0, 0, "lastName", global::System.Data.DataRowVersion.Current, null));
        }
        ...
        public virtual int Update(string firstName, int Original_ID) {
            if ((firstName == null)) {
        ...
        public virtual int InsertQuery(string firstName, string Nqwwsw) {
            ...
            if ((Nqwwsw == null)) {
                ...
                command.Parameters[1].Value = ((string)(Nqwwsw));
            }
